"""
Interface del repositorio de Insumo.
Define el contrato para operaciones de base de datos del módulo de insumos.
"""

from abc import ABC, abstractmethod
from typing import List, Optional, Dict

from .model import Insumo
from .schemas import InsumoCreate, InsumoUpdate


class InsumoRepositoryInterface(ABC):
    """Interface para el repositorio de insumos."""
    ...
    @abstractmethod
    def get_inusmo_cod(self, codigo: str) -> Optional[Insumo]:
        """Obtiene un insumo por su código."""
        pass
